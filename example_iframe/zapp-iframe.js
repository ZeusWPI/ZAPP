...
/*
Zapp iframe host side code.
This contains logic for positioning and communicating between button and dropdown iframes
*/
...
const outsideclickhandler = (ev) => {
  ...
  if (!clickedInside) {
    ...
    document
      .getElementById("zappbutton")
      .contentWindow.postMessage({ type: "outsideclick" }, "*");
    dropdown.contentWindow.postMessage({ type: "outsideclick" }, "*");
  }
};
